          ...
          <div className="lg:col-span-8 space-y-4 text-left">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <div className="flex items-center gap-2 text-xs text-slate-300 font-semibold bg-white/10 backdrop-blur-md px-3.5 py-2.5 rounded-xl border border-white/10">
                ...
                <span>{t('verified_direct_requisition')}</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col justify-center">
            <div className="bg-slate-900/90 backdrop-blur-md p-5 sm:p-6 rounded-2xl border border-slate-700/90 shadow-xl space-y-4 text-left">
              ...
              <div className="space-y-1">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{t('target_compensation_label')}</span>
              ...
              {userRole === 'admin' && (
                <button
                  ...
                  title={t('manage_banners_tooltip')}
                >
                  <Settings className="w-3.5 h-3.5 text-emerald-400" />
                  <span>{t('admin_manage_banners_btn')}</span>
                </button>
              )}
        ...
        <div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center justify-between">
          <div className="flex items-center gap-2">
            {activeBanners.map((banner, idx) => (
              <button
                ...
                aria-label={`${t('slide_label')} ${idx + 1}`}
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-slate-400 hidden sm:inline font-mono">
              {currentIndex + 1} {t('of_label')} {activeBanners.length} {t('live_campaigns_suffix')}
            </span>
            <div className="flex items-center gap-1">
              <button
                ...
                title={t('previous_banner_tooltip')}
              >
